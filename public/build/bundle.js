...
var app = (function () {
    ...
    /* node_modules\svelte-bootstrap-icons\lib\MoonFill.svelte generated by Svelte v3.59.2 */

    const file$4 = "node_modules\\svelte-bootstrap-icons\\lib\\MoonFill.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path, "d", "M6 .278a.768.768 0 0 1 .08.858 7.208 7.208 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277.527 0 1.04-.055 1.533-.16a.787.787 0 0 1 .81.316.733.733 0 0 1-.031.893A8.349 8.349 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.752.752 0 0 1 6 .278z");
    			add_location(path, file$4, 0, 170, 170);
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	validate_slots('MoonFill', slots, ['default']);
    ...
    class MoonFill extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* node_modules\svelte-bootstrap-icons\lib\SunFill.svelte generated by Svelte v3.59.2 */

    const file$3 = "node_modules\\svelte-bootstrap-icons\\lib\\SunFill.svelte";
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	let $$restProps = compute_rest_props($$props, omit_props_names);
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('SunFill', slots, ['default']);
    ...
    class SunFill extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_if_block_1$1(ctx) {
    	...
    	sunfill = new SunFill({
    			props: { width: 24, height: 24, cursor: "pointer" },
    			$$inline: true
    		});

    	const block = {
    		c: function create() {
    			create_component(sunfill.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(sunfill, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(sunfill.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(sunfill.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(sunfill, detaching);
    		}
    	};
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			create_component(moonfill.$$.fragment);
    		},
    		m: function mount(target, anchor) {
    			mount_component(moonfill, target, anchor);
    			current = true;
    		},
    		i: function intro(local) {
    			if (current) return;
    			transition_in(moonfill.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(moonfill.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			destroy_component(moonfill, detaching);
    		}
    	};
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span0, file$2, 19, 2, 588);
    			add_location(span1, file$2, 20, 2, 613);
    			attr_dev(defs, "id", "SvgjsDefs6312");
    			add_location(defs, file$2, 26, 82, 14507);
    			attr_dev(path0, "xmlns", "http://www.w3.org/2000/svg");
    			attr_dev(path0, "d", "M0 0h100v100H0z");
    			add_location(path0, file$2, 26, 235, 14660);
    			...
    			add_location(g0, file$2, 26, 114, 14539);
    			...
    			add_location(path1, file$2, 26, 461, 14886);
    			...
    			add_location(g1, file$2, 26, 307, 14732);
    			...
    			add_location(path2, file$2, 26, 1473, 15898);
    			...
    			add_location(g2, file$2, 26, 1318, 15743);
    			...
    			add_location(svg, file$2, 26, 3, 14428);
    			attr_dev(span2, "id", "icon");
    			attr_dev(span2, "class", "svelte-jyi2fr");
    			add_location(span2, file$2, 21, 2, 638);
    			add_location(span3, file$2, 28, 2, 20638);
    			attr_dev(span4, "id", "theme");
    			add_location(span4, file$2, 29, 2, 20667);
    			attr_dev(header, "class", "svelte-jyi2fr");
    			add_location(header, file$2, 18, 0, 576);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(span4, "click", /*click_handler*/ ctx[2], false, false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function switchTheme() {
    		if (theme === 'dark') {
    			...
    			document.getElementsByTagName('body')[0].style.background = 'var(--bg-light)';
    			document.getElementsByTagName('main')[0].style.color = '#000000';
    		} else {
    			$$invalidate(0, theme = 'dark');
    			document.getElementsByTagName('body')[0].style.background = 'var(--bg-dark)';
    	...
    	const click_handler = () => switchTheme();
    	$$self.$capture_state = () => ({ MoonFill, SunFill, theme, switchTheme });
    	...
    	return [theme, switchTheme, click_handler];
    }
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(footer, "class", "svelte-18gwjse");
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 28, 6, 1042);
    			add_location(p0, file, 29, 6, 1067);
    			add_location(p1, file, 35, 6, 1523);
    			add_location(p2, file, 36, 6, 1623);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file, 19, 6, 463);
    			add_location(p0, file, 20, 6, 488);
    			add_location(p1, file, 25, 6, 834);
    			add_location(p2, file, 26, 6, 925);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h2, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-13xa3vb");
    			add_location(h1, file, 14, 1, 256);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 15, 14, 287);
    			add_location(p, file, 15, 1, 274);
    			attr_dev(div, "id", "about-me");
    			attr_dev(div, "class", "svelte-13xa3vb");
    			add_location(div, file, 17, 4, 402);
    			...
    			attr_dev(img0, "class", "flag-icon svelte-13xa3vb");
    			add_location(img0, file, 39, 4, 1718);
    			...
    			attr_dev(img1, "class", "flag-icon svelte-13xa3vb");
    			add_location(img1, file, 40, 4, 1862);
    			add_location(article, file, 16, 2, 387);
    			attr_dev(main, "class", "svelte-13xa3vb");
    			add_location(main, file, 13, 0, 247);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
